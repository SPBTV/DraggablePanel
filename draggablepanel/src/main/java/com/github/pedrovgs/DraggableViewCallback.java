...
class DraggableViewCallback extends ViewDragHelper.Callback {
    ...
    public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
        draggableView.onViewPositionChanged();
    }
    ...
    public void onViewReleased(View releasedChild, float xVel, float yVel) {
        ...
        if (draggableView.isMinimized() && !draggableView.isDragViewAtRight()) {
    ...
    /**
     * Override method used to configure the vertical drag. Restrict the motion of the dragged
     * child
